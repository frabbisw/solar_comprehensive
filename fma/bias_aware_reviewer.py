...
SYSTEM_PROMPT = (
    ...
    "think solely on the task, do not get biased towards any group or individual, do not instruct to add any new logic. just work on the biased logics inside the method. "
