...
# sbatch slurm.sh --exp 3     --start 0 --end 100 --samples 1 --rounds 3     --solar_dir ~/solar/solar_comprehensive/fairness_test     --model_dir ~/solar/solar_comprehensive/results/gpt35     --temp 0.3>
